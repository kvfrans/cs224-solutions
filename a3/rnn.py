...
class RNN_Model():
    ...
    def loss(self, logits, labels):
        ...
        loss = ce + (l2_loss_composition + l2_loss_projection)*self.config.l2

        # END YOUR CODE
        # print ce.get_shape()
        # print l2_loss_composition.get_shape()
        # print l2_loss_projection.get_shape()
        return loss
